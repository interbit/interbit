export default {
  ...
  intro: {
    content: `Underpinned by our core technology, the Interbit platform is designed to bring the developer and consumer communities together.

The Interbit platform provides the development community with access to patent-pending blockchain technology, examples, and best practices for building the next generation of distributed applications.`
  },
  sections: [
    {
      title: 'Chain joining (patent-pending)',
      content: `Chain joining allows distinct blockchains to securely share data. Interbit apps use many blockchains, obsoleting the single-blockchain model.`
    },
    {
      title: 'True privacy',
      content: `True privacy is achieved by segregating confidential data into distinct chains. This guarantees that not even metadata is leaked.`
    },
    {
      title: 'Fault tolerant',
      content: `Applications can survive node faults, both benign and malicious.`
    },
    {
      title: 'Scalability',
      content: `Single blockchains don’t scale. Interbit can scale horizontally by adding more, joined chains.`
    },
    {
      title: 'Blockchain in a browser',
      content: `Interbit is extremely lightweight and supports the capability of running a blockchain node within a browser.`
    },
    {
      title: '100% new code',
