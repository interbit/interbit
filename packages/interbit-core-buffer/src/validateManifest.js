// TODO: Make this validate the correct manifest.json state shape, not the config

import { ROOT, COVENANTS, CHAINS, MANIFEST_HASH } from './constants'

const validateManifest = config => {
  const requiredProps = [ROOT, COVENANTS, CHAINS, MANIFEST_HASH]
