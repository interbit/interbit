ContentBarWithButton example:
```js
<ContentBarWithButton
  title="Title for content bar with button"
  ...
  callToAction={{to: "#", type: "button", text: "Link text bacon bacon", image: "placeholder-md.png"}}
