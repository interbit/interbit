...
describe('generateManifest(location, interbitConfig, covenants, originalManifest)', () => {
  ...
  it('includes necessary configuration data in manifest tree', () => {
    ...
    should.ok(rootChain.chainIds.control)
    should.ok(rootChain.chainIds.public)
    ...
    should.ok(controlChain.chainIds.public)
    should.ok(controlChain.chainIds.interbitRoot)
